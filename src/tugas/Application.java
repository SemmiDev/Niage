...
public class Application {
    public static void main(String[] args) {
        // polimorfishm dinamis -> parent child
...
class Budaya {
    ...
    // show -> polimorfishm statis / overloading
    public void show(String namaBudaya) {
        System.out.println(namaBudaya);
    }
    // show -> polimorfishm statis / overloading
    public void show(String namaBudaya, String asalBudaya) {
        System.out.println(namaBudaya + asalBudaya);
    }
    // show -> polimorfishm statis / overloading
    public void show(String namaBudaya, String asalBudaya, JenisBudaya jenisBudaya) {
        System.out.println(namaBudaya + asalBudaya + jenisBudaya);
    }
